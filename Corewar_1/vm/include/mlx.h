...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/12 09:45:21 by abinois           #+#    #+#             */
/*   Updated: 2019/09/12 09:52:36 by abinois          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**  endian: useless on macos, client and graphicalframework have the same endian
*/
...
int				mlx_mouse_hook (void *win_ptr, int (*funct_ptr)(), void *para);
int				mlx_key_hook (void *win_ptr, int (*funct_ptr)(), void *para);
int				mlx_expose_hook (void *win_ptr, int (*funct_ptr)(), void *para);
int				mlx_loop_hook (void *mlx_ptr, int (*funct_ptr)(), void *para);
